import { DIFFICULTIES, RATINGS, STRATEGIES } from './constants.js';
import {
  difficultyFace,
  emptyState,
  levelCard,
...
function plannerFilterMarkup(filters) {
  return `<div class="filter-grid">
    <div class="filter-group"><span class="filter-label">Difficulty</span><div class="filter-pills">${DIFFICULTIES.filter((d) => d !== 'N/A').map((difficulty) => pillCheckbox('difficulty', difficulty, difficulty, filters.difficulties.includes(difficulty))).join('')}</div></div>
