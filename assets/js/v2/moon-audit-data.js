...
export const MOON_AUDIT_LEVELS = [
  { section: 'glitched', name: 'Small space', id: '87363427', delta: 3, effect: 'extra', specialObtainable: true, note: 'Bugged twilight-rated platformer that can still award 3 moons even though it does not behave like a normal rated-platformer search result.', condition: 'Special obtainable case' },

  { section: 'ephemeral', name: 'Level Devil', id: '134077341', delta: 10, effect: 'extra', exactExtra: true, matchPrefixes: ['d_'], note: "April Fools' 2026 Daily Level. MoonGrinder only counts this when the dedicated daily-completion marker is present. The spreadsheet notes that its expired 10-moon value cannot be removed.", condition: 'Expired Daily' },
  ...
  { section: 'unrate', name: 'Try to die', id: '104710963', delta: 8, effect: 'extra', exactExtra: true, matchPrefixes: ['c_'], note: 'Unrated and later deleted after being identified as a copied level. If its online completion marker remains in the save, these 8 moons are treated as persistent unobtainable moons.', condition: 'Deleted' },
  { section: 'unrate', name: 'Dynamo', id: '110467524', delta: 7, effect: 'extra', exactExtra: true, matchPrefixes: ['c_'], note: 'Copied level that was unrated and later deleted. If its online completion marker remains in the save, these 7 moons are treated as persistent unobtainable moons.', condition: 'Deleted' },
  { section: 'unrate', name: 'The Parkour Trials', id: '113849805', delta: 4, effect: 'extra', exactExtra: true, matchPrefixes: ['c_'], note: 'Deleted after being identified as a copy of The XCat Trials. If its online completion marker remains in the save, these 4 moons are treated as persistent unobtainable moons.', condition: 'Deleted' },
